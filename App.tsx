          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section className="bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-200 overflow-hidden">
              ...
              <div className="p-10">
                ...
                {uploadSuccess && activeTab === 'settings' && (
                  <div className="mt-4 p-4 bg-green-100 text-green-700 rounded-2xl text-sm font-black flex items-center justify-center gap-2 animate-in fade-in duration-300">
                    <CheckCircle2 className="w-5 h-5" /> Šablóna bola úspešne nahraná a uložená!
                  </div>
                )}
              </div>
            </section>
            ...
            <section className="bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-200 overflow-hidden">
              ...
              <div className="p-10 space-y-8">
                ...
                <button 
                  onClick={addEmployee}
                  className="w-full py-10 border-4 border-dashed border-slate-200 rounded-[2.5rem] text-slate-400 hover:border-green-400 hover:text-green-600 hover:bg-green-50/30 transition-all flex flex-col items-center justify-center gap-4 font-black group bg-slate-50/50"
                >
                  <div className="p-4 bg-white rounded-2xl shadow-lg shadow-slate-200 group-hover:shadow-green-100 transition-all group-hover:scale-110">
                    <UserPlus className="w-8 h-8" />
                  </div>
                  <span>Pridať ďalšieho zamestnanca</span>
                </button>
              </div>
            </section>
          </div>
